...
const batchWriteData = async(propsA, propsB) => {
  try{
    const params = {
      RequestItem: {
        TableName: [
          {
            PutRequest: {
              Item: {
                entryYear: propsA.entryYear,
                id: propsA.studentId,
                name: propsA.name,
                class: propsA.class,
                address: propsA.address,
                phoneNumber: propsA.phoneNumber
              }
            }
          },
          {
            PutRequest: {
              Item: {
                entryYear: propsB.entryYear,
                id: propsB.studentId,
                name: propsB.name,
                class: propsB.class,
                address: propsB.address,
                phoneNumber: propsB.phoneNumber
              }
            }
          }
        ]
